...
class RolesTableSeedeer extends Seeder
{
    ...
    public function run()
    {
        ...
        $role->givePermissionTo('ver_precio_sugerido','ver_precio_minorista', 'ver_precio_mayorista', 'ver_precio_taller');
//        $role->givePermissionTo('ver_precio');
        $role1 = Role::create(['name' => 'cliente_minorista']);
        $role2 = Role::create(['name' => 'cliente_mayorista']);
        $role3 = Role::create(['name' => 'cliente_taller']);
        ...
        $role3->givePermissionTo('ver_precio_taller');
    }
}
