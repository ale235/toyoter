...
@if((is_null($cliente->verdatostoyoter) || ($cliente->verdatostoyoter == 1)) || ($role == "cliente_minorista"))
...
@if((($cliente->vercosto == 1) || is_null($cliente->vercosto)) || ($role == "cliente_minorista"))
