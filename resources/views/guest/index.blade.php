    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 table-responsive" style="overflow-x:auto;">
                @role('admin')
                <table id="exampleadmin" class="table table-striped table-bordered dt-responsive nowrap table-dark" style="width:100%">
                    <thead>
                    <tr>
                        <th>Descripción</th>
                        <th>Código</th>
...
<script>
        $(document).ready(function() {
            ...
            $('#exampleadmin').DataTable({
                "serverSide": true,
                "processing": true,
                "ajax": "{{url('api/buscarRepuestosAdmin')}}",
                "columns": [
                    {data: 'descripcion', name: 'repuestos.descripcion'},
                    {data: 'codigo', name: 'repuestos.codigo'},
                    {data: 'btn'},
                    {data: 'precio_id_sugerido', name: 'precios.precio_sugerido'},
                    {data: 'precio_id_minorista', name: 'precios.precio_mayorista'},
                    {data: 'precio_id_mayorista', name: 'precios.precio_minorista'},
                    {data: 'precio_id_taller', name: 'precios.precio_taller'},
                    {data: 'seccion_id'},
                    {data: 'marca_repuesto_id'},
                    {data: 'marca_vehiculo_id'},
                ],
            ...
            $('#exampleadmin tbody').on('click', '.shop', function (e){
                //todo
                event.preventDefault();
                var item;
                if($(e.currentTarget).closest('tr').hasClass('child')){
